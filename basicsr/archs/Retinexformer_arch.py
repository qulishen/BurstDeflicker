...
class Illumination_Estimator(nn.Module):
    def __init__(
        ...
        self.depth_conv = nn.Conv2d(
            n_fea_middle, n_fea_middle, kernel_size=3, stride=1, padding=1
        )
...
class Denoiser(nn.Module):
    def __init__(self, in_dim=9, out_dim=1, dim=31, level=2, num_blocks=[2, 4, 4]):
...
if __name__ == "__main__":
    ...
    x = torch.randn(1, 3, 512, 512) #  flops:161.379155968,params:20.446435
