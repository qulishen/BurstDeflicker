...
class LocalContextExtractor(nn.Module):
    ...
    def __init__(self, dim, reduction=8):
        ...
        self.conv = nn.Sequential(
            ...
            nn.Conv2d(
                dim // reduction, dim // reduction, kernel_size=3, padding=1, bias=True
            ),
    ...
    def __init__(
        ...
        if resi_connection == "1conv":
            self.dilated_conv = nn.Conv2d(
                dim, dim, kernel_size=3, padding=2, bias=True, dilation=2
            )
    ...
    def __init__(
        ...
        **kwargs,
        ...
        for i_layer in range(self.num_layers):
            layer = ContextAwareTransformerBlock(
                dim=embed_dim,
...
if __name__ == "__main__":
    ...
    x = torch.randn(1, 9, 512, 512) #  flops:161.379155968,params:20.446435
